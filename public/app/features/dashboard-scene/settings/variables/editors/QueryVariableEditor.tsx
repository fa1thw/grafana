...
export function QueryVariableEditor({ variable, onRunQuery }: QueryVariableEditorProps) {
  ...
  const onCustomOptionsChange = (staticOptions: StaticOptionsType) => {
    onRunQuery();
    variable.setState({ staticOptions });
  };

  const onCustomOptionsOrderChange = (staticOptionsOrder: StaticOptionsOrderType) => {
    onRunQuery();
  ...
  return (
    <QueryVariableEditorForm
      ...
      onStaticOptionsChange={onCustomOptionsChange}
      onStaticOptionsOrderChange={onCustomOptionsOrderChange}
    />
  );
}
